...
spec:
  ...
  - name: sloth-slo-sli-recordings-svc01-slo02
    rules:
    - expr: |
        slo:numerator_correction:ratio5m{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[5m]))
        )
      ...
      record: slo:sli_error:ratio_rate5m
    - expr: |
        slo:numerator_correction:ratio30m{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[30m]))
        )
      ...
      record: slo:sli_error:ratio_rate30m
    - expr: |
        slo:numerator_correction:ratio1h{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[1h]))
        )
      ...
      record: slo:sli_error:ratio_rate1h
    - expr: |
        slo:numerator_correction:ratio2h{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[2h]))
        )
      ...
      record: slo:sli_error:ratio_rate2h
    - expr: |
        slo:numerator_correction:ratio6h{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[6h]))
        )
      ...
      record: slo:sli_error:ratio_rate6h
    - expr: |
        slo:numerator_correction:ratio1d{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[1d]))
        )
      ...
      record: slo:sli_error:ratio_rate1d
    - expr: |
        slo:numerator_correction:ratio3d{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
        * on() (1 -
        (
        sum(rate(http_request_duration_seconds_count{job="myservice",code!~"(5..|429)"}[3d]))
        )
